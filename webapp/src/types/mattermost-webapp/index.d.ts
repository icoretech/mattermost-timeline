...
export type PluginConfiguration = {
  ...
  sections: Array<
    PluginConfigurationSection | PluginConfigurationCustomSection
  >;
};
...
export type PluginConfigurationCustomSetting =
...
export type PluginConfigurationSetting =
...
export interface PluginRegistry {
  ...
  registerPostTypeComponent(
    ...args:
      | [typeName: string, component: ReactResolvable]
      | [
          {
            typeName: string;
            component: ReactResolvable;
  ...
  registerPostCardTypeComponent(
    ...args:
      | [type: string, component: ReactResolvable]
      | [
          {
            type: string;
            component: ReactResolvable;
  ...
  registerMainMenuAction(
    ...args:
      | [text: ReactResolvable, action: () => void, mobileIcon: ReactResolvable]
      | [
          {
  ...
  registerChannelHeaderMenuAction(
    ...args:
      | [component: ReactResolvable, fn: (channelID: string) => void]
      | [
          {
            component: ReactResolvable;
  ...
  registerUserGuideDropdownMenuAction(
    ...args:
      | [text: ReactResolvable, action: (fileInfo: FileInfo) => void]
      | [
          {
            text: ReactResolvable;
            action: (fileInfo: FileInfo) => void;
  ...
  registerFileUploadMethod(
    ...args:
      | [
          icon: ReactResolvable,
          action: (
            checkPluginHooksAndUploadFiles: (files: FileList | File[]) => void,
          ) => void,
          text: ReactResolvable,
        ]
      | [
          {
            icon: ReactResolvable;
            action: (
              checkPluginHooksAndUploadFiles: (
                files: FileList | File[],
              ) => void,
            ) => void;
            text: ReactResolvable;
    ...
    ...args:
      | [
          hook: (
            ...
            | object
            | Promise<{ message: string; args: ContextArgs } | object>,
        ]
      | [
          {
            hook: (
  ...
  registerAdminConsoleCustomSection(
    ...args:
      | [key: string, component: ReactResolvable]
      | [
          {
            key: string;
            component: ReactResolvable;
  ...
  registerRightHandSidebarComponent(
    ...args:
      | [component: ReactResolvable, title: ReactResolvable]
      | [
          {
            component: ReactResolvable;
  ...
  registerNeedsTeamRoute(
    ...args:
      | [route: string, component: ReactResolvable]
      | [
          {
            route: string;
            component: ReactResolvable;
    ...
    ...args:
      | [
          hook: (
            post: Partial<Post>,
            oldPost: Post,
          ) => Promise<{ error: { message: string } } | { post: Post }>,
        ]
      | [
          {
            hook: (
